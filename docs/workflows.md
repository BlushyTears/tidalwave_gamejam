...
> **Tip**: You may want to set up a [GitHub ruleset](https://docs.github.com/en/repositories/configuring-branches-and-merges-in-your-repository/managing-rulesets/about-rulesets) to require that all commits to `main` pass CI.
> 
> <details>
...
> **Important**: Using this workflow requires some setup. We will go through this now.
